...
const Section2 = () => {
  return (
    <div className="flex flex-col justify-center gap-12 items-center mt-4">
      ...
      <marquee behavior="" width="90%" scroll-amount="50" direction="right">
      ...
      <div className="flex justify-center items-center">
        <div className="bg-[#F3F3F3] border-[3px] border-[#E8E8E8]  flex gap-20 p-8 px-8 rounded-lg mb-10">
          <div className="flex flex-col justify-center items-center">
            <h1 className="font-bold text-transparent text-6xl bg-clip-text bg-gradient-to-r from-[#5046E6] to-[#0B00AB] ... ">
              57%
            </h1>
